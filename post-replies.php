...
<body style="background-color:#EFEFEF">
    ...
    <div class="inner-banner">
        <div class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold">Businesses Interest Replies</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.php">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Businesses Interest Replies</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="w3l-contact py-5" id="contact">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-5" style="max-width:500px; margin-top:-50px;">
                <h3 class="title-style" style="font-size:25px;">Businesses Interest Replies</h3>
            </div>
