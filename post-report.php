...
<body style="background-color:#EFEFEF">
    ...
    <div class="inner-banner">
        <div class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold">My Business Post Report</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.html">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>My Business Post Report</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section class="w3l-contact py-5" id="contact">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-5" style="max-width:500px; margin-top:-50px;">
                <h3 class="title-style">My Business Post Report</h3>
            </div>
  ...
  <?php
      ...
      $registration_data=$db->get_all_self_posted_details($current_login_user);
    ...
    ?>
		...
		<div style="float:right; position:relative; right:0px; top:0;">
			...
			<a href="post-replies.php?post_id=<?php echo $id; ?>" style="float:right; font-size:13px; color:purple; border:1px solid #DFDFDF; background-color:#FFF; text-align:center; width:120px;">View Details</a>
			<br />
			...
			<a href="post-replies.php?post_id=<?php echo $id; ?>&set_seen" style="float:right; font-size:13px; color:orangered; border:1px solid #DFDFDF; background-color:#FFF; text-align:center; margin-top:5px; width:120px;">Posts Replies
			<?php
				$post_count = $db->get_total_all_notification_count_of_post($current_login_user,$id);
			?>
			(<?php echo $post_count; ?>)
			</a><br />
